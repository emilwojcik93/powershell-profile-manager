...
function Show-ReleaseSummary {
    ...
    Write-ReleaseLog "  [OK] Release package directory" "Success"
    Write-ReleaseLog "  [OK] Release archive (ZIP)" "Success"
    Write-ReleaseLog "  [OK] Release notes" "Success"
    Write-ReleaseLog "  [OK] Updated installer script" "Success"
    Write-ReleaseLog ""
